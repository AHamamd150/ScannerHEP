...
#################################
from Example_scan_input_NMSSM import *
paths = str(pathS)+'/'
#################################
...
def dir_prepare(i):
    ...
    if Use_vegas:
        shutil.copy(str(path)+'/source/scan_general_vegas.py',str(path)+"/Out_%s/SPheno_%s"%(str(SPHENOMODEL),str(i)))
    elif Use_ML:
        shutil.copy(str(path)+'/source/scan_general_ML.py',str(path)+"/Out_%s/SPheno_%s"%(str(SPHENOMODEL),str(i)))    
    else:    
...
""")
    ...
    if Use_vegas:
        oldrunfile1 = open(str(path)+"/Out_%s/SPheno_%s/scan_general_vegas.py"%(str(SPHENOMODEL),str(i)))
    elif Use_ML:
        oldrunfile1 = open(str(path)+"/Out_%s/SPheno_%s/scan_general_ML.py"%(str(SPHENOMODEL),str(i)))    
    else:
    ...
    newrunfile1.close()
    if Use_vegas:
        os.rename(str(path)+"/Out_%s/SPheno_%s/newfile1"%(str(SPHENOMODEL),str(i)),str(path)+"/Out_%s/SPheno_%s/scan_general_vegas.py"%(str(SPHENOMODEL),str(i)))
    elif Use_ML:
        os.rename(str(path)+"/Out_%s/SPheno_%s/newfile1"%(str(SPHENOMODEL),str(i)),str(path)+"/Out_%s/SPheno_%s/scan_general_ML.py"%(str(SPHENOMODEL),str(i)))    
    else:
...
def  spheno_runs(i):
          ...
          if Use_vegas:
              os.system('python3 '+str(path)+"/Out_%s/SPheno_%s/scan_general_vegas.py"%(str(SPHENOMODEL),str(i)))
          elif Use_ML:
              os.system('python3 '+str(path)+"/Out_%s/SPheno_%s/scan_general_ML.py"%(str(SPHENOMODEL),str(i)))    
          else:
              os.system('python3 '+str(path)+"/Out_%s/SPheno_%s/scan_general.py"%(str(SPHENOMODEL),str(i)))    
def  CPH_runs(i):
